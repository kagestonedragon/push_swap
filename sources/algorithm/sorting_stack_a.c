...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/22 16:31:29 by emedea            #+#    #+#             */
/*   Updated: 2019/09/22 16:32:12 by emedea           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	get_operation(t_push_swap *p, int mediana,
		int *push_counter, int *rotate_counter)
{
